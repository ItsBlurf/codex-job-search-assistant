...
The salary lookup tool (`tools/salary_lookup.py`) lets you benchmark company salaries against a baseline from your own data. It can be used during the `job-apply` workflow to show how a company's compensation compares to market rates.
